...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionSetReview.label'
        db.add_column('cmsplugin_submissionsetreview', 'label',
                      self.gf('django.db.models.fields.CharField')(default='Previous submissions', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionSetReview.label'
        db.delete_column('cmsplugin_submissionsetreview', 'label')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubmissionSetReview'
        db.create_table('cmsplugin_submissionsetreview', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('submission_set_tag', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('cms_saq', ['SubmissionSetReview'])

        # Adding field 'SubmissionSet.created'
        db.add_column('cms_saq_submissionset', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True),
                      keep_default=False)

        # Adding field 'SubmissionSet.updated'
        db.add_column('cms_saq_submissionset', 'updated',
    ...
    def backwards(self, orm):
        # Deleting model 'SubmissionSetReview'
        db.delete_table('cmsplugin_submissionsetreview')

        # Deleting field 'SubmissionSet.created'
        db.delete_column('cms_saq_submissionset', 'created')

        # Deleting field 'SubmissionSet.updated'
        db.delete_column('cms_saq_submissionset', 'updated')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cms_saq.submissionsetreview': {
            'Meta': {'object_name': 'SubmissionSetReview', 'db_table': "'cmsplugin_submissionsetreview'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'submission_set_tag': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },

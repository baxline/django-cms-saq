...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionSetReview.count_optional'
        db.add_column('cmsplugin_submissionsetreview', 'count_optional',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionSetReview.count_optional'
        db.delete_column('cmsplugin_submissionsetreview', 'count_optional')
